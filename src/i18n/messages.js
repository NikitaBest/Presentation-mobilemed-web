...
export const MESSAGES = {
  ru: {
    ...
    'auth.lead': 'Войдите или зарегистрируйтесь по email и паролю, чтобы сохранять историю сканов.',
  ...
  en: {
    ...
    'auth.brand': 'MobileMed',
    'auth.title': 'Sign in',
    'auth.lead': 'Sign in or register with email and password to save your scan history.',
