...
export const MESSAGES = {
  ru: {
    ...
    'results.openInterpretationLoading': 'Готовим расшифровку…',
    'results.openInterpretationHint': 'Подробный текст по вашему скану (ИИ)',
    'results.openInterpretationHintLoading': 'Кнопка станет доступной, когда текст будет готов',
  ...
  en: {
    ...
    'results.openInterpretationLoading': 'Preparing interpretation…',
    'results.openInterpretationHint': 'Detailed AI summary for your scan',
    'results.openInterpretationHintLoading': 'The button will unlock when the text is ready',
